namespace Repository.Contracts
{
    public interface IGenericFiltrableRepository<T, TIdType, TFilter> : IGenericRepository<T, TIdType> where T : class, IIdObject<TIdType>
    {
        ...
        public Task<IReadOnlyCollection<T>> GetPageContentAsync(TFilter filter, int? page = default, int? pageSize = default, CancellationToken cancellationToken = default);
    }
}
