namespace Clients.ProductService
{
    //----------------------
    // <auto-generated>
...
#pragma warning disable 8765 // Disable "CS8765 Nullability of type of parameter doesn't match overridden member (possibly because of nullability attributes)."
    ...
    namespace Clients.ProductServiceClient
    {
        ...
        public interface IProductApiClient
        {
            ...
            /// <returns>OK</returns>
            /// <exception cref="ProductApiException">A server side error occurred.</exception>
            System.Threading.Tasks.Task<System.Guid> ProductPOSTAsync(CreateProductCommand body);

            /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
            /// <returns>OK</returns>
            /// <exception cref="ProductApiException">A server side error occurred.</exception>
            System.Threading.Tasks.Task<System.Guid> ProductPOSTAsync(CreateProductCommand body, System.Threading.CancellationToken cancellationToken);
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
            ...
            public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ProductListDto>> ProductAllAsync(System.Collections.Generic.IEnumerable<System.Guid> ids, string namePart, string descriptionPart, double? priceStart, double? priceEnd, bool? isAvailable, System.Collections.Generic.IEnumerable<System.Guid> producerIds, System.DateTimeOffset? creationDateStart, System.DateTimeOffset? creationDateEnd, int? page, int? pageSize, System.Threading.CancellationToken cancellationToken)
            {
                ...
                try
                {
                    using (var request_ = new System.Net.Http.HttpRequestMessage())
                    {
                        ...
                        // Operation Path: "ProductApi/Product"
                        urlBuilder_.Append("ProductApi/Product");
                        urlBuilder_.Append('?');
                        if (ids != null)
                        {
            ...
            /// <returns>OK</returns>
            /// <exception cref="ProductApiException">A server side error occurred.</exception>
            public virtual System.Threading.Tasks.Task<System.Guid> ProductPOSTAsync(CreateProductCommand body)
            {
            ...
            /// <returns>OK</returns>
            /// <exception cref="ProductApiException">A server side error occurred.</exception>
            public virtual async System.Threading.Tasks.Task<System.Guid> ProductPOSTAsync(CreateProductCommand body, System.Threading.CancellationToken cancellationToken)
            {
                var client_ = _httpClient;
                var disposeClient_ = false;
                try
            ...
            public virtual async System.Threading.Tasks.Task<ProductDto> ProductGETAsync(System.Guid id, System.Threading.CancellationToken cancellationToken)
            {
                ...
                try
                {
                    using (var request_ = new System.Net.Http.HttpRequestMessage())
                    {
                        ...
                        var urlBuilder_ = new System.Text.StringBuilder();
                        if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                        // Operation Path: "ProductApi/Product/{id}"
                        urlBuilder_.Append("ProductApi/Product/");
